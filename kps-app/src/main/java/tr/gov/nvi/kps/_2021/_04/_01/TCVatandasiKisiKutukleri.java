 ...
 *       &lt;sequence&gt;
 *         &lt;element name="GeciciKimlikBilgisi" type="{http://kps.nvi.gov.tr/2021/04/01}TCGeciciKimlikBilgisi" minOccurs="0"/&gt;
 *         &lt;element name="HataBilgisi" type="{http://kps.nvi.gov.tr/2011/01/01}Parametre" minOccurs="0"/&gt;
 *         &lt;element name="KisiBilgisi" type="{http://kps.nvi.gov.tr/2021/04/01}TCKisiBilgisi" minOccurs="0"/&gt;
 *         &lt;element name="NufusCuzdaniBilgisi" type="{http://kps.nvi.gov.tr/2021/04/01}TCCuzdanBilgisi" minOccurs="0"/&gt;
 *         &lt;element name="TCKKBilgisi" type="{http://kps.nvi.gov.tr/2021/04/01}TCKK" minOccurs="0"/&gt;
 *         &lt;element name="TCKKFotografBilgisi" type="{http://kps.nvi.gov.tr/2021/04/01}TCKKFotoBilgisi" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class TCVatandasiKisiKutukleri {
    ...
    @XmlElementRef(name = "GeciciKimlikBilgisi", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "NufusCuzdaniBilgisi", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<TCCuzdanBilgisi> nufusCuzdaniBilgisi;
    @XmlElementRef(name = "TCKKBilgisi", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<TCKK> tckkBilgisi;
    @XmlElementRef(name = "TCKKFotografBilgisi", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
