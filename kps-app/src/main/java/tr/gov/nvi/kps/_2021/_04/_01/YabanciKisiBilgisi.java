 ...
 *         &lt;element name="Statu" type="{http://kps.nvi.gov.tr/2011/01/01}Parametre" minOccurs="0"/&gt;
...
public class YabanciKisiBilgisi {
    ...
    @XmlElementRef(name = "AnneKimlikNo", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> anneKimlikNo;
    @XmlElementRef(name = "BabaKimlikNo", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> babaKimlikNo;
    @XmlElementRef(name = "BitisTarihiBelirsizOlmaNeden", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Parametre> bitisTarihiBelirsizOlmaNeden;
    @XmlElementRef(name = "DogumTarih", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<TarihBilgisi> dogumTarih;
    @XmlElementRef(name = "DogumYerKod", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> dogumYerKod;
    @XmlElementRef(name = "DurumBilgisi", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<YabanciKisiDurumBilgisi> durumBilgisi;
    @XmlElementRef(name = "EsKimlikNo", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> esKimlikNo;
    @XmlElementRef(name = "GercekKisiKimlikNo", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "IzinBaslangicTarih", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> izinBaslangicTarih;
    @XmlElementRef(name = "IzinBitisTarih", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> izinBitisTarih;
    @XmlElementRef(name = "IzinDuzenlenenIl", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Parametre> izinDuzenlenenIl;
    @XmlElementRef(name = "IzinNo", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<String> izinNo;
    @XmlElementRef(name = "KaynakBirim", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Parametre> kaynakBirim;
    @XmlElementRef(name = "KazanilanTCKimlikNo", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "OlumTarih", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<TarihBilgisi> olumTarih;
    @XmlElementRef(name = "Statu", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Parametre> statu;
    @XmlElementRef(name = "TemelBilgisi", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<YabanciKisiTemelBilgisi> temelBilgisi;
    @XmlElementRef(name = "Uyruk", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
     ...
     *     
     */
    public JAXBElement<Parametre> getStatu() {
        return statu;
    }
     ...
     *     
     */
    public void setStatu(JAXBElement<Parametre> value) {
        this.statu = value;
    }
