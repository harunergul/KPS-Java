...
public class MaviKartBilgi {
    ...
    @XmlElementRef(name = "Birim", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "DogumYer", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "KartKayitNo", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "MedeniHal", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Parametre> medeniHal;
    @XmlElementRef(name = "No", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> no;
    @XmlElementRef(name = "OncekiSoyad", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<String> oncekiSoyad;
    @XmlElementRef(name = "Seri", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "VerilisNeden", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Parametre> verilisNeden;
    @XmlElementRef(name = "VerilmeTarih", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
