 ...
 *         &lt;element name="SurucuBelgeYuklendiMi" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="SurucuBelgeYuklenmeTarih" type="{http://kps.nvi.gov.tr/2011/01/01}TarihBilgisi" minOccurs="0"/&gt;
...
@XmlType(name = "TCKK", propOrder = {
    ...
    "sonGecerlilikTarih",
    "soyad",
    "surucuBelgeYuklendiMi",
    "surucuBelgeYuklenmeTarih",
    "tcKimlikNo",
    "verenMakam"
})
public class TCKK {

    @XmlElementRef(name = "Ad", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<String> ad;
    @XmlElementRef(name = "AnneAd", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<String> anneAd;
    @XmlElementRef(name = "BabaAd", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<String> babaAd;
    @XmlElementRef(name = "Cinsiyet", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "KanGrubu", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Parametre> kanGrubu;
    @XmlElementRef(name = "SeriNo", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<String> seriNo;
    @XmlElementRef(name = "SonGecerlilikTarih", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<TarihBilgisi> sonGecerlilikTarih;
    @XmlElementRef(name = "Soyad", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<String> soyad;
    @XmlElementRef(name = "SurucuBelgeYuklendiMi", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> surucuBelgeYuklendiMi;
    @XmlElementRef(name = "SurucuBelgeYuklenmeTarih", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<TarihBilgisi> surucuBelgeYuklenmeTarih;
    ...
    @XmlElementRef(name = "VerenMakam", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    ...
    /**
     * Gets the value of the surucuBelgeYuklendiMi property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<Boolean> getSurucuBelgeYuklendiMi() {
        return surucuBelgeYuklendiMi;
    }

    /**
     * Sets the value of the surucuBelgeYuklendiMi property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Boolean }{@code >}
     *     
     */
    public void setSurucuBelgeYuklendiMi(JAXBElement<Boolean> value) {
        this.surucuBelgeYuklendiMi = value;
    }

    /**
     * Gets the value of the surucuBelgeYuklenmeTarih property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link TarihBilgisi }{@code >}
     *     
     */
    public JAXBElement<TarihBilgisi> getSurucuBelgeYuklenmeTarih() {
        return surucuBelgeYuklenmeTarih;
    }

    /**
     * Sets the value of the surucuBelgeYuklenmeTarih property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TarihBilgisi }{@code >}
     *     
     */
    public void setSurucuBelgeYuklenmeTarih(JAXBElement<TarihBilgisi> value) {
        this.surucuBelgeYuklenmeTarih = value;
    }
