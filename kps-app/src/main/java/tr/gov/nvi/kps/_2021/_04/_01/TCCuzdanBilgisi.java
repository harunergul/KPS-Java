...
public class TCCuzdanBilgisi {
    ...
    @XmlElementRef(name = "CuzdanKayitNo", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> cuzdanKayitNo;
    @XmlElementRef(name = "CuzdanVerilmeNeden", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "VerildigiIlce", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
