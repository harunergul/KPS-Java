 ...
 *         &lt;element name="OncekiYabanciKimlikNo" type="{http://www.w3.org/2001/XMLSchema}long" minOccurs="0"/&gt;
...
@XmlType(name = "TCKisiBilgisi", propOrder = {
    ...
    "hataBilgisi",
    "kayitYeriBilgisi",
    "oncekiYabanciKimlikNo",
    "tcKimlikNo",
    "temelBilgisi"
})
public class TCKisiBilgisi {

    @XmlElementRef(name = "AnneTCKimlikNo", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> anneTCKimlikNo;
    @XmlElementRef(name = "AnneUstSoyBulunamadi", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> anneUstSoyBulunamadi;
    @XmlElementRef(name = "BabaTCKimlikNo", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> babaTCKimlikNo;
    @XmlElementRef(name = "BabaUstSoyBulunamadi", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "EsTCKimlikNo", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "KayitYeriBilgisi", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<TCKisiKayitYeriBilgisi> kayitYeriBilgisi;
    @XmlElementRef(name = "OncekiYabanciKimlikNo", namespace = "http://kps.nvi.gov.tr/2021/04/01", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> oncekiYabanciKimlikNo;
    ...
    /**
     * Gets the value of the oncekiYabanciKimlikNo property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link Long }{@code >}
     *     
     */
    public JAXBElement<Long> getOncekiYabanciKimlikNo() {
        return oncekiYabanciKimlikNo;
    }

    /**
     * Sets the value of the oncekiYabanciKimlikNo property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Long }{@code >}
     *     
     */
    public void setOncekiYabanciKimlikNo(JAXBElement<Long> value) {
        this.oncekiYabanciKimlikNo = value;
    }
